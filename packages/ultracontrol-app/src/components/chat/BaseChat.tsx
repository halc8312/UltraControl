      ...
      >
        ...
        <div ref={scrollRef} className="flex flex-col lg:flex-row overflow-y-auto w-full h-full">
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
                ...
                >
                  ...
                  <div className="flex justify-between items-center text-sm p-4 pt-2">
                    <div className="flex gap-1 items-center">
                      ...
                      {chatStarted && isClient && <ExportChatButton exportChat={exportChat} />}
                    </div>
                    {input.length > 3 ? (
            ...
            {!chatStarted && isClient && ImportButtons(importChat)}
            {!chatStarted && isClient && ExamplePrompts(sendMessage)}
          </div>
          {isClient && <Workbench chatStarted={chatStarted} isStreaming={isStreaming} />}
        </div>
      </div>
    );
