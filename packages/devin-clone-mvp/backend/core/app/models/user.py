...
class User(Base):
    ...
    # subscription = relationship("Subscription", back_populates="user", uselist=False)  # Stripe disabled
    # payments = relationship("Payment", back_populates="user")  # Stripe disabled
